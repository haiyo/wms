<?php
namespace Library\Util\Scheduler\Traits;
use \Library\Util\Scheduler\Cron\CronExpression;
 ...
 * @version $Id: Interval.dll.php, v 2.0 Exp $
...
trait Interval {
    ...
    private function validateCronSequence( $minute=null, $hour=null, $day=null, $month=null, $weekday=null ) {
        return ['minute'  => $this->validateCronRange( $minute, 0, 59 ),
