 ...
 ***************************************************************************/
//
// $Id: PSStatus.js 494 2011-08-23 11:38:09Z jacky672 $
//
...
appendcss("./pickers/PSStatus/css/psstatus.css");
...
function psstatus_populate(xml) {
    ...
    $("Plugins Plugin_PSStatus Process", xml).each(function psstatus_getprocess(idp) {
        ...
        if (status === 1 && !isNaN(status)) {
            state = "<span style=\"display:none;\">" + status.toString() + "</span><images src=\"./pickers/PSStatus/gfx/online.png\" alt=\"online\" />";
        }
        else {
            state = "<span style=\"display:none;\">" + status.toString() + "</span><images src=\"./pickers/PSStatus/gfx/offline.png\" alt=\"offline\" />";
        }
