 ...
 ***************************************************************************/
//
// $Id: MDStatus.js 489 2011-08-17 07:50:15Z jacky672 $
//
...
appendcss("./pickers/MDStatus/css/mdstatus.css");
...
function mdstatus_buildinfos(xml, id) {
    ...
    button += "<h3 style=\"cursor: pointer\" id=\"sPlugin_MDStatus_Info" + id + "\"><images src=\"./gfx/bullet_toggle_plus.png\" alt=\"plus\" style=\"vertical-align:middle;\" />" + genlang(4, false, "MDStatus") + "</h3>";
    button += "<h3 style=\"cursor: pointer; display: none;\" id=\"hPlugin_MDStatus_Info" + id + "\"><images src=\"./gfx/bullet_toggle_minus.png\" alt=\"minus\" style=\"vertical-align:middle;\" />" + genlang(4, false, "MDStatus") + "</h3>";
...
function mdstatus_diskicon(xml) {
    ...
    $("Disks Disk", xml).each(function mdstatus_getdisk(id) {
        ...
        html += "<images class=\"plugin_mdstatus_biun\" src=\"./pickers/MDStatus/gfx/" + img + "\" alt=\"" + alt + "\" />";
