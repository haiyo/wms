...
class XML
{
    ...
    /**
     * array with all enabled pickers (name)
     *
     * @var array
     */
    protected $_plugins;
     ...
     * @var boolean
     */
    protected $_plugin_request = false;
    
    /**
     * generate the entire xml with all pickers or only a part of the xml (main or plugin)
     *
     * @var boolean
     */
    protected $_complete_request = false;
     ...
     *
     * @param boolean $complete   generate xml with all pickers or not
     ...
     * @return void
     */
    protected function _buildVitals()
    {
     ...
     * @return void
     */
    protected function _buildNetwork()
    {
     ...
     * @return void
     */
    protected function _buildHardware()
    {
        $dev = new HWDevice();
     ...
     * @return void
     */
    protected function _buildMemory()
    {
     ...
     * @return Void
     */
    protected function _fillDevice($mount, $dev, $i)
    {
     ...
     * @return void
     */
    protected function _buildFilesystems()
    {
     ...
     * @return void
     */
    protected function _buildMbinfo()
    {
     ...
     * @return void
     */
    protected function _buildUpsinfo()
    {
    ...
    /**
     * include xml-trees of the pickers to the main xml
     *
     * @return void
     */
    protected function _buildPlugins()
    {
