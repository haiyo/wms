...
function __autoload($class_name)
{
    ...
    $class_name = str_replace('PhpSysInfo\\', '', $class_name); // Aurora Edit - remove namespace
    $dirs = array('/pickers/'.$class_name.'/', '/includes/', '/includes/interface/', '/includes/to/', '/includes/to/device/', '/includes/os/', '/includes/mb/', '/includes/plugin/', '/includes/xml/', '/includes/web/', '/includes/error/', '/includes/js/', '/includes/output/', '/includes/ups/');
...
set_error_handler('PhpSysInfo\errorHandlerPsi'); */
?>