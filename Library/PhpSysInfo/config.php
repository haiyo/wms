 ...
 * @version   SVN: $Id: config.php.new 457 2011-04-15 23:07:39Z namiltd $
 ...
 * - define('PSI_JS_COMPRESSION', 'JSMin'); //activate JSMin compression
 * - define('PSI_JS_COMPRESSION', 'JavaScriptPacker'); //activate JavaScriptPacker compression
 */
define('PSI_JS_COMPRESSION', false);
 ...
 * List of pickers should look like "plugin,plugin,plugin". See /pickers directory
 * - define('PSI_PLUGINS', 'MDStatus,PS'); // list of pickers
 * - define('PSI_PLUGINS', false); //no pickers
 * included pickers:
