...
class HTMLPurifier_HTMLModule_Tidy_XHTMLAndHTML4 extends HTMLPurifier_HTMLModule_Tidy
{
    ...
    public function makeFixes() {
        ...
        // @border for images ------------------------------------------------
        $r['images@border'] = new HTMLPurifier_AttrTransform_Border();
        ...
        // @hspace for images ------------------------------------------------
        $r['images@hspace'] = new HTMLPurifier_AttrTransform_ImgSpace('hspace');
        ...
        // @vspace for images ------------------------------------------------
        $r['images@vspace'] = new HTMLPurifier_AttrTransform_ImgSpace('vspace');
