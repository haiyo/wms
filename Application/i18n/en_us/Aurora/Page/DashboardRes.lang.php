...
class DashboardRes extends Resource {
    ...
    function __construct( ) {
        ...
        $this->contents['LANG_LEAVE_INTRO'] = 'Check your leave balances, approval status and history';
        ...
        $this->contents['LANG_STAFF_INTRO'] = 'Search for coworkers and their contact information';
        ...
        $this->contents['LANG_PAYSLIP_INTRO'] = 'View history or download your monthly payslips';
