    ...
    <div class="col-lg-3">
        ...
        <div class="panel bg-blue-400">
            <div class="panel-body">
                ...
                <h3 class="no-margin">Leave Balance</h3>
                Today's revenue
    ...
    <div class="col-lg-3">
        ...
        <div class="panel bg-blue-400">
            <div class="panel-body">
                ...
                <h3 class="no-margin">Leave Pending Approval</h3>
                Today's revenue
                <div class="text-muted text-size-small">$37,578 avg</div>
            </div>
                        ...
                        <ul class="media-list content-group">
                            <li class="media stack-media-on-mobile">
                                <div class="media-left">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="http://demo.interface.club/limitless/layout_1/LTR/default/assets/images/demo/flat/1.png" class="img-responsive img-rounded media-preview" alt="">
                            ...
                            <li class="media stack-media-on-mobile">
                                <div class="media-left">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="http://demo.interface.club/limitless/layout_1/LTR/default/assets/images/demo/flat/21.png" class="img-responsive img-rounded media-preview" alt="">
                                            <span class="zoom-image"><i class="icon-play3"></i></span>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <ul class="media-list content-group">
                            <li class="media stack-media-on-mobile">
                                <div class="media-left">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="http://demo.interface.club/limitless/layout_1/LTR/default/assets/images/demo/flat/12.png" class="img-responsive img-rounded media-preview" alt="">
                                            <span class="zoom-image"><i class="icon-play3"></i></span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <li class="media stack-media-on-mobile">
                                <div class="media-left">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="http://demo.interface.club/limitless/layout_1/LTR/default/assets/images/demo/flat/15.png" class="img-responsive img-rounded media-preview" alt="">
                                            <span class="zoom-image"><i class="icon-play3"></i></span>
                                        </a>
                                    </div>
                                </div>
