...
var Dashboard = function () {
    ...
    var _MonthlySalesAreaChart = function(element, height, color) {
        ...
        if($(element).length > 0) {
            ...
            d3.json(Aurora.ROOT_URL + "data/dashboard/monthly_sales.json", function (error, data) {
    ...
    return {
        ...
        initCharts: function() {
            ...
            // Area charts
            _MonthlySalesAreaChart('#monthly-sales-stats', 100, '#7e57c2');
            _MessagesAreaChart('#messages-stats', 40, '#7e57c2');
